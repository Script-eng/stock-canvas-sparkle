      ...
      <div className="min-h-screen flex w-full bg-background">
        ...
        <SidebarInset className="flex-1">
          <header className="flex items-center justify-between p-6 border-b bg-card">
            <div>
              <h1 className="text-2xl font-bold text-foreground">Market Activity</h1>
              <p className="text-sm text-muted-foreground">A detailed look at today's top moving stocks</p>
            </div>
